async function test() {
    const queries = [
        "ai user:karpathy OR user:hwchase17 OR user:simonw stars:>10",
        "llm org:openai OR org:anthropic OR org:google-deepmind stars:>50",
        '"" user:karpathy OR user:hwchase17'
    ];
